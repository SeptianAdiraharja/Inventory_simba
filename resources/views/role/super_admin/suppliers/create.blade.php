...
<div class="container-fluid py-4 animate__animated animate__fadeIn">
  ...
  {{-- 📥 IMPORT SUPPLIER --}}
  {{-- ======================== --}}
  <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4 smooth-fade">
    <div class="card-header bg-white border-0 py-3 px-4 d-flex flex-wrap justify-content-between align-items-center border-bottom">
      <div class="d-flex align-items-center gap-2">
        <i class="ri-upload-line fs-5" style="color:#FF9800;"></i>
        <h5 class="fw-bold mb-0" style="color:#FF9800;">Import Data Supplier</h5>
      </div>
      <small class="text-muted">Unggah file Excel (.xls atau .xlsx)</small>
    </div>

    <div class="card-body bg-light p-4">
      <form action="{{ route('super_admin.suppliers.import') }}" method="POST" enctype="multipart/form-data" class="d-flex align-items-center gap-3 flex-wrap">
        @csrf
        <input type="file" name="file" accept=".xls,.xlsx" required
               class="form-control border-0 rounded-3 shadow-sm px-3 py-2"
               style="max-width: 300px; background:#fff; border-left:4px solid #FF9800 !important;">
