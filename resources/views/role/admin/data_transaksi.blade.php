                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            {{-- Edit --}}
                            <button class="btn btn-sm btn-outline-info rounded-pill fw-semibold smooth-btn" data-bs-toggle="modal" data-bs-target="#editModal"
                              data-cart-item-id="{{ $item->id }}" data-item-name="{{ $item->item->name }}"
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <button class="btn btn-sm btn-outline-info rounded-pill fw-semibold smooth-btn data-bs-toggle="modal"
