...
<div class="container-fluid py-4 animate__animated animate__fadeIn">
    ...
    <div class="d-flex flex-column gap-3 mb-4">
        ...
        <!-- Breadcrumb Section -->
        <div class="bg-white shadow-sm rounded-4 px-4 py-3 d-flex flex-wrap justify-content-between align-items-center gap-3 animate__animated animate__fadeInDown smooth-fade">
