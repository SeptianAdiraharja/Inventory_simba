...
/*
 * STYLING UTAMA
 * Warna utama: Orange (#FF9800) dengan variasi
 * Background: Putih dengan sentuhan hangat (#fffaf4)
 */
...
/* Efek shadow pada modal */
.modal-content:hover {
    box-shadow: 0 0 15px rgba(255,152,0,0.25);
}

/*
 * FIX UNTUK SWEETALERT
 * Memastikan SweetAlert muncul di atas modal
 */
.swal2-container {
 ...
 * - itemout.js: Logika custom untuk pemindaian barang
 -->
