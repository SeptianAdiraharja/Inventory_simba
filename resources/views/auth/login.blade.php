<x-guest-layout>
    <div id="mainContainer"
        ...
        <div id="leftPanel"
            ...
            style="background-image: url('{{ asset('assets/img/backgrounds/Login.png') }}'); background-size: cover; background-position: center; background-repeat: no-repeat;">

            <!-- Preload background image secara inline -->
            <div style="display: none;">
                <img src="{{ asset('assets/img/backgrounds/Login.png') }}" alt="" onload="this.parentElement.style.display='none'">
            </div>
        ...
        <div id="rightPanel"
            ...
            <!-- Preload logo UPELKES -->
            <div style="display: none;">
                <img src="{{ asset('assets/img/icons/upelkes.png') }}" alt="" onload="this.parentElement.style.display='none'">
            </div>
            ...
            <div id="upelkesLogo"
                ...
                <div class="relative flex justify-center items-center">
                    ...
                    <!-- Logo UPELKES dengan loading="eager" -->
            ...
            <div id="loginForm"
                ...
                <!-- Preload logo SIMBA -->
                <div style="display: none;">
                    <img src="{{ asset('assets/img/icons/simba.png') }}" alt="" onload="this.parentElement.style.display='none'">
                </div>

                <div class="flex justify-center">
                    <!-- Logo SIMBA dengan loading="eager" -->
    ...
    <!-- SCRIPT -->
    <script>
        // Preload gambar dengan JavaScript
        document.addEventListener('DOMContentLoaded', function() {
            const imagesToPreload = [
                '{{ asset("assets/img/backgrounds/Login.png") }}',
                '{{ asset("assets/img/icons/upelkes.png") }}',
                '{{ asset("assets/img/icons/simba.png") }}'
            ];
